...
### 3. Post-choice satisfaction check (S-M)
...
### 5. Satisficing-reinforcing copy pass (XS)
...
### 6. Gentler default timeout escalation (S)
...
### 7. Mute toggle for the timeout alarm (XS)
...
### 9. Setup-time question presets (S)
